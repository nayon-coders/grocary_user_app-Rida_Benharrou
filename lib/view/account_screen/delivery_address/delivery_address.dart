              ...
              child: Column(
                ...
                children: [
                  ...
                  DropdownSearch<String>(
                    ...
                    addressController.postCodeList.value,
                  ...
                  AppInput(
                    ...
                    validator: (value) =>
                    value!.isEmpty
                        ? "Indiquez dans ce champs toutes information utile à la livraison, ex: rideau de fer ouvert, déposez les marchandises et refermez."
                        : null,
                  ...
                  AppInput(
                    validator: (value) =>
                    value!.isEmpty
                        ? " Indiquez le nom et/ou prénom de la personne à contacter"
                        : null,
                  ...
                  AppInput(
                    validator: (value) =>
                    value!.isEmpty
                        ? "Indiquez le mobile de la personne à contacter"
                        : null,
        ...
        bottomNavigationBar: Container(
          ...
          child: Obx(() {
            return AppButton(
                ...
                name: addressModel != null
                    ? "Modifier Adresse"
                    : "Ajouter une Nouvelle Adresse", onClick: () async {
